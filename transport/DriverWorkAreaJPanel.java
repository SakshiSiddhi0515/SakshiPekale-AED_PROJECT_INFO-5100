...
public class DriverWorkAreaJPanel extends javax.swing.JPanel {
   ...
   private UserAccount userAccount;  
    ...
    private OrgTransport to;
    /**
     * Creates new form DriverWorkAreaJPanel
     */
    public DriverWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, OrgDirectory od) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
         this.userAccount = userAccount;
         this.od = od;
         this.to = (OrgTransport)organization;
