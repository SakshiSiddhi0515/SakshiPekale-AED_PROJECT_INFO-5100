...
private JPanel userProcessContainer;
    private SupervisorRequest request;
    private  EcoSystem ecoSystem;
    /**
     * Creates new form SupervisorProcessRequestAreaJPanel
     */
    public SupervisorProcessRequestAreaJPanel(JPanel userProcessContainer, SupervisorRequest request, EcoSystem ecoSystem) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.request = request;
        this.ecoSystem = ecoSystem;
        resultComboBox.removeAllItems();
        resultComboBox.addItem(SupervisorRequest.REQUEST_APPROVED);
 ...
 @Override
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        {
            People_volunteer volunteer = (People_volunteer)request.getSender().getPerson();
        ...
        if(request.getTestResult().equals(SupervisorRequest.REQUEST_APPROVED))
        {
            ...
            boolean emailSent = EmailText.sendEmail(emailMsgTxt.toString(),emailId,userName, password);
            if(!emailSent)
            {
