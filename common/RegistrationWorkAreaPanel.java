...
import Model.enterprise.Enterhelp;
import Model.enterprise.EnterHospital;
import Model.enterprise.EnterSchool;
...
public class RegistrationWorkAreaPanel extends javax.swing.JPanel {
   ...
   //     fillForm();
    ...
    private void initComponents() {
        ...
        isHelpSeeker.setText("Help Needed");
        isHelpSeeker.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        isVolunteer.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        helpSeekerNw.setText("Nearest City");
        ...
        helpSeekerPaneLayout.setHorizontalGroup(
            ...
            .addGroup(helpSeekerPaneLayout.createSequentialGroup()
                ...
                .addGroup(helpSeekerPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(confirmPasswordField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(passwordField, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(userNameJTxtField, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(helpSeekerNetworkCombo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32))
            .addGroup(helpSeekerPaneLayout.createSequentialGroup()
                .addGap(76, 76, 76)
        ...
        helpSeekerPaneLayout.setVerticalGroup(
            ...
            .addGroup(helpSeekerPaneLayout.createSequentialGroup()
                ...
                .addGroup(helpSeekerPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(helpSeekerNw, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(71, Short.MAX_VALUE))
        );

        manageEnt.setFont(new java.awt.Font("Arial Hebrew Scholar", 1, 24)); // NOI18N
        manageEnt.setText("Welcome to Helping Hands Club");
        ...
        isDoctorRadioBtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(manageEnt, javax.swing.GroupLayout.PREFERRED_SIZE, 421, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(306, 306, 306))
            .addGroup(layout.createSequentialGroup()
                .addGap(275, 275, 275)
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as help seeker","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  JOptionPane.showMessageDialog(null, "HelpSeeker Organization does not exist for the enterprise! "+enterprise.getName(),"warning", JOptionPane.WARNING_MESSAGE);
                   return;      
                    ...
                    {
                        JOptionPane.showMessageDialog(null, "User Name already exists!, Please Enter valid user name","warning", JOptionPane.WARNING_MESSAGE);
                        organization.getPersonDirectory().getCustomerLsit().remove((People_help)person);
                        return;
                    }
                    // To get help seeker org
                    
                    UserAccount userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new Role_helpseeker());
                   ...
                   userAccount.setNetwork((network)helpSeekerNw);
                    ...
                    request.setMessage(SupervisorRequest.REQUEST_APPROVAL);
                    request.setSender(userAccount);
                    request.setStatus(SupervisorRequest.REQUEST_SENT);
                    request.setRequestDate(new Date());
                    
                   // For Supervisor  
                  for(enterprises e : helpSeekerNw.getEnterpriseDirectory().getEnterpriseList())
                  {
                      if(e instanceof Enterhelp)
                      {
                ...
                else if(isVolunteer.isSelected())
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Volunteer","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  person.setVolunteer(true);
                   ...
                   String userName = EmailText.generateUserName(lastNameField.getText());
                    if(!organization.getUserAccountDirectory().checkIfUsernameIsUnique(userName))
                    {
                        userName = EmailText.generateUserName(lastNameField.getText());
                    }
                    String password = EmailText.generatePassword(firstNameField.getText());
                    String emailMsg = buildEmailTxtMsg(userName, password);
                    
                    boolean emailSent = EmailText.sendEmail(emailMsg, emailIDField.getText(),userName, password);
//                    if(!emailSent)
//                    {
...
//                    }
                    ...
                    UserAccount userAccount = organization.getUserAccountDirectory().addUserAccount(userName,password , person, new Role_volunteer());
                    userAccount.setPerson(person);
                ...
                if(isDoctorRadioBtn.isSelected() )
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Dcotor","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  person = organization.getPersonDirectory().addPerson();
                    ...
                    UserAccount userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new Role_doctor());
                    userAccount.setPerson(person);
          ...
          try
                {
                 for (network n : ecoSystem.getNetworkList())
                   ...
                   for(enterprises e : n.getEnterpriseDirectory().getEnterpriseList())
                      {
                           if(e instanceof EnterSchool && isVolunteer.isSelected())
                           {
                             this.enterprise = e;
                             network = n;
                            }
                           else if(e instanceof Enterhelp && isHelpSeeker.isSelected())
                           {
                             this.enterprise = e;
                              network = n;
                            }
                            else if(e instanceof EnterHospital && isDoctorRadioBtn.isSelected())
                           {
                             this.enterprise = e;
                              network = n;
                           }
    ...
    public void getOrganization(String orgVal, enterprises e){
     ...
     for (Organization organization : e.getOrganizationDirectory().getOrganizationList()){
       ...
       if(orgVal.equals("Volunteer") && organization instanceof OrgVolunteer)
        {
              this.organization = organization;
              this.personDirectory = organization.getPersonDirectory();
        
        }     
     else if(orgVal.equals("HelpSeeker") && organization instanceof OrgSeeker)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             }  
       
       else if(orgVal.equals("Doctor") && organization instanceof OrgDoctor)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             } 
