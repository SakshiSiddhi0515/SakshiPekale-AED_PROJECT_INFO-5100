...
public class RequestVolunteerForHelp extends javax.swing.JPanel {
     ...
     */
    public RequestVolunteerForHelp(JPanel userProcessContainer, UserAccount userAccount, People_volunteer volunteer, OrgVolunteer organization,EcoSystem ecoSystem) {
        initComponents();
     ...
     for(WorkRequest workRequest : userAccount.getWorkQueue().getWorkRequestList())
        {
         if(workRequest.getMessage().equalsIgnoreCase("Need Help"))
         {
           ...
           rowData[0] = ((HelpRequest)workRequest).getRequestId();
           rowData[1] = ((HelpRequest)workRequest).getNeedHelp().getHelp();
